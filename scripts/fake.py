...
# 将根目录添加到python的模块搜索路径中
back = os.path.dirname
# E:\onedrive_personal\OneDrive\Python\Django\my_blogproject
...
if __name__ == "__main__":
    ...
    user = User.objects.create_superuser("huozhesiqu","siquhuozhe@gmail.com","huozhesiqu")
